...
<body>
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            // Retrieve the current value from the form data
            $currentValue = isset($_POST['currentValue']) ? $_POST['currentValue'] : "";
    ...
    <div class="container">
        ...
        <form method="post" class="btn_wrap">
            ...
            <input type="hidden" name="currentValue" value="<?php echo htmlspecialchars($currentValue); ?>">
